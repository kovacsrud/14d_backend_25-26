using KutyakWebAPI.model;
using Microsoft.AspNetCore.Mvc;
using System.Text.Json;

namespace KutyakWebAPI.Controllers
{
    [ApiController]
    public class KutyanevController : Controller
    {
        ...
        public IActionResult GetKutyaNevek()
        {
            try
            {
                ...
                return Ok(kutyaData.context.Set<Kutyanevek>().Select(i => new {i.Id,i.Kutyanev }));

                //A navigációs propertyk miatt hibát okoz!
                //return Ok(kutyaData.Kutyanevek);
            }
            catch (Exception ex)
            {
        ...
        [HttpPut("/api/kutyanevek")]
        public IActionResult PutKutyanev(dynamic data)
        {
            try
            {
